...
| 015 | Restore Mod Screenshots | Beta | Stops the error shown when opening a mod with screenshots in the Paradox Mods browser, so its screenshots load. Declares the `ScreenshotUrls` field the browser assigns but never defines. |
