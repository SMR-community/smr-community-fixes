...
| 016 | Restore Mod Details | Beta | Loads the current thumbnail and preserves rich description formatting with clickable links on a mod's Paradox Mods detail page. |
