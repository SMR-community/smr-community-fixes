...
| 016 | Restore Mod Details | Beta | Loads current thumbnails in Browse All, Installed Mods, and mod details, and restores website-style bold text, paragraph/list spacing, and clickable links. |
